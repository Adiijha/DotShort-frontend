...
const QRPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 text-white">
      <div className="w-full max-w-lg bg-white/10 backdrop-blur-lg border border-white/20 p-6 sm:p-8 rounded-xl shadow-xl space-y-6">
        ...
        {/* Display QR Code */}
        <div className="w-48 h-48 sm:w-64 sm:h-64 bg-white/5 backdrop-blur-md rounded-md flex ml-10 md:ml-24 justify-center items-center border border-white/20">
          {qrCode ? (
            <img
              src={qrCode}
        ...
        <div className="text-center text-sm sm:text-lg">
          ...
          <Link to="/shortenlink" className="text-teal-400 hover:underline">
            Shorten a URL
          </Link>
        </div>
      </div>
